...
const TableReact = () => {
  ...
  //       </div>
  //       <div className="flex justify-end bg-transparent  px-2  mt-2 py-2 border-1 border-b-0 ">
  ...
  //             }`}
  //           >
  //             <tr className="bg-[#222E3A]/[6%] border-x-2 border-t-2 border-red">
  ...
  //             </tr>
  //           </thead>
  //           <tbody className="border-x-2 border-red border-b-2">
  ...
  return(
    <>
    <h3 className="text-center font-bold">processing...........</h3></>
  );
