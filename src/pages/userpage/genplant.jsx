...
const GenPlant = () => {
    ...
    const [newEntry, setNewEntry] = useState({
        com_id: '', gen_name: '', con_htscno: '', weg_htscno: '', doc: '', gen_type: '', inj_volt: '', ban_op: '', priority: '',fromdate: d1,
        todate: d2,
        user: "ADMIN",
        date_time: d3,
    });
    ...
    const handleidChange = (e) => {
        ...
        if (filteredData) {
            ...
            setNewEntry((newEntry) => ({
                ...newEntry,
                com_id: filteredData.com_id, // Store the entire selectedPlant object or its specific fields
            }));
            // setNewEntry({ ...newEntry, priority: filteredData.priority });
        } else {
            console.log("No matching plant found");
